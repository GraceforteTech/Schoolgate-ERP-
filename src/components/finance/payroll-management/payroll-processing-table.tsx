...
import { MoreVertical, Eye, Edit, FileText, Printer, CheckCircle2, PauseCircle } from "lucide-react";
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger } from "@/components/ui/dropdown-menu";

const staffPayroll = [
  { id: "ST001", name: "John Doe", dept: "Science", school: "Secondary", basic: 150000, allowance: 45000, gross: 195000, pension: 15000, tax: 12000, net: 168000, status: "Paid" },
  { id: "ST002", name: "Jane Smith", dept: "Arts", school: "Primary", basic: 140000, allowance: 35000, gross: 175000, pension: 14000, tax: 10000, net: 151000, status: "Pending" },
  { id: "ST003", name: "Bob Wilson", dept: "Admin", school: "Main", basic: 120000, allowance: 25000, gross: 145000, pension: 12000, tax: 8000, net: 125000, status: "On Hold" },
];
