        ...
        <div className="xl:col-span-9 space-y-8">
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <KPICard title="Total Fees Billed" value={formatCurrency(stats?.totalFeesBilled || 0)} change="+12%" icon={TrendingUp} color="blue" />
              <KPICard title="Total Fees Collected" value={formatCurrency(stats?.totalFeesCollected || 0)} change="+5%" icon={TrendingUp} color="emerald" />
              <KPICard title="Net Position" value={formatCurrency(stats?.netPosition || 0)} change="+18%" icon={Zap} color="emerald" />
              ...
              <KPICard title="Total Expenses" value={formatCurrency(stats?.totalExpenses || 0)} change="+8%" icon={TrendingUp} color="rose" />
              <KPICard title="Approved Expenses" value={formatCurrency(stats?.approvedExpenses || 0)} change="+10%" icon={TrendingUp} color="rose" />
              <KPICard title="Pending Payments" value={stats?.pendingPayments.toString() || "0"} change="Pending approval" icon={Clock} color="indigo" />
            </div>
          </section>
